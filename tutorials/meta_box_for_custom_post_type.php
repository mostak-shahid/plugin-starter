...
public function display_meta_options() {
    ...
    ?>
    <label><?php _e( 'Customer ID:', 'text-domain' ); ?></label><input name="customer_id" value="<?php echo $customer_id; ?>" /><br>
    <?php

    $customer_address = $custom["customer_address"][0];
    ?>
    <label><?php _e( 'Customer Address:', 'text-domain' ); ?></label><textarea name="customer_address"><?php echo $customer_address; ?></textarea>
    <?php
