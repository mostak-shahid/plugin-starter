...
class Frontend
{
	...
	public function enqueue_scripts()
	{
		...
		wp_enqueue_script($this->plugin_name . '-public-ajax', PLUGIN_STARTER_URL . 'public/js/public-ajax.js', array('jquery'), $this->version, false);
		wp_enqueue_script($this->plugin_name . '-public-script', PLUGIN_STARTER_URL . 'public/js/public-script.js', array('jquery'), $this->version, false);
		$ajax_params = array(
			'admin_url' => admin_url(),
