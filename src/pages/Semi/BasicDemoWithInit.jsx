...
const BasicDemoWithInit = () => {
    ...
    const { 
        Input, InputNumber, Select, Cascader, DatePicker, TimePicker, 
        TextArea, CheckboxGroup, Checkbox, RadioGroup, Radio, Slider, 
        Rating, Switch, TagInput, Section
    } = Form;
    ...
    return (
        <>
            ...
            {!loading && (
                <Form
                    initValues={settingData.basic}                // ← controlled form
                    onValueChange={(v) => {
                        console.log(v);
            ...
            >
                ...
                <Checkbox value="false" field="agree" noLabel>
