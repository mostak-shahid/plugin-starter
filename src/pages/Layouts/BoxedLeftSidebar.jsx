    ...
    return (
        <BoxedLayout sidebarPosition="left" sidebar={sidebar}>     
            <Card className="mb-0 rounded-0">
                <Card.Header>Boxed Layout - Left Sidebar</Card.Header>
                <Card.Body>
                    <h3>Boxed Layout with Left Sidebar</h3>
                    <p>This layout demonstrates a boxed container with a left sidebar for navigation.</p>
