                                    ...
                                    <div className="col-lg-10">
                                        {
                                            ...
                                            : <h5 className="pl-heading-1 fw-600 text-text">{__("Basic Settings", "plugin-starter")}</h5>
                                        }
                                        <h6 className="pl-heading-1 fw-600 text-text">{__("Enable", "plugin-starter")}</h6>
                                        <p className="pl-body text-text">{__( "Lorem ipsum dolor sit amet consectetur", "plugin-starter" )}</p>
                                    </div>                                    
