        ...
        <div className='pb-4'>
            <Row>
                <Col lg={6} className='mt-4'>
                    <Card>
                        <Card.Header>{__('Logs Over Time', 'plugin-starter')}</Card.Header>
                        <Card.Body><VChart spec={overTimeSpec} /></Card.Body>                        
                    </Card>
                </Col>
                <Col lg={6} className='mt-4'>
                    <Card>
                        <Card.Header>{__('Logs by Category', 'plugin-starter')}</Card.Header>
                        <Card.Body>
                ...
                <Col lg={6} className='mt-4'>
                    <Card>
                        <Card.Header>{__('Top Users', 'plugin-starter')}</Card.Header>
                        <Card.Body>
                ...
                <Col lg={6} className='mt-4'>
                    <Card>
                        <Card.Header>{__('Category Share', 'plugin-starter')}</Card.Header>
                        <Card.Body>
                ...
                <Col lg={6} className='mt-4'>
                    <Card>
                        <Card.Header>{__('Top IPs', 'plugin-starter')}</Card.Header>
                        <Card.Body>
                ...
                <Col lg={6} className='mt-4'>
                    <Card>
                        <Card.Header>{__('Hourly Activity', 'plugin-starter')}</Card.Header>
                        <Card.Body>
