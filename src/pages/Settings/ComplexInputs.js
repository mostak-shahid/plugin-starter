    ...
    return (
        <>
            ...
            <div className="setting-unit py-4">
                <Row>
                    <Col lg={12}>
                        <h6 className="h6">{__("ImageSelector", "plugin-starter")}</h6>
                        <p>{__("Lorem", "plugin-starter")}</p>
                    </Col>
                    {
                        !settingsLoading &&
            ...
            <div className="setting-unit py-4">
                <Row>
                    <Col lg={6}>
                        <h6 className="h6">{__("ColorPickerControl", "plugin-starter")}</h6>
                        <p>{__("Lorem", "plugin-starter")}</p>
                    </Col>
                    {
                        !settingsLoading &&
            ...
            <div className="setting-unit py-4">
                <Row>
                    <Col lg={6}>
                        <h6 className="h6">{__("BackgroundControl", "plugin-starter")}</h6>
                        <p>{__("Lorem", "plugin-starter")}</p>
                    </Col>
                    {
                        !settingsLoading &&
