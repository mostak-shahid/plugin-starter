...
function App() {
  ...
  const OPTIONS_API_URL = "/plugin-starter/v1/options"; // No /wp-json here, apiFetch adds it
  ...
  const handleResetAll = async () => {
      ...
      if (confirmation) {       
          ...
          try {
              ...
              formData.append("_admin_nonce", plugin_starter_ajax_obj._admin_nonce);
      ...
      <div className="plugin-starter-settings-container">
        ...
        <div className="plugin-starter-settings">
          <div className="part-title">
            <h1>{__( "React Page", "plugin-starter" )}</h1> </div>
          <div className="part-options">
            <table className="form-table" role="presentation">
              <tbody>
                <tr className="plugin_starter_row">
                  <th scope="row">
                  ...
                  <td>
                    <div className="position-relative input_text">
                      <label htmlFor="text-input">
                        <input 
                          type="text" 
                          name="plugin_starter_options[base-input][text-input]" 
                          id="text-input" 
                  ...
                  <td>
                    <div className="position-relative input_email">
                      <label htmlFor="email-input">
                        <input 
                          type="email" 
                          name="plugin_starter_options[base-input][email-input]" 
                          id="email-input" 
                  ...
                  <td>
                    <div className="position-relative input_color">
                      <label htmlFor="color-input">
                        <input 
                          type="color" 
                          name="plugin_starter_options[base-input][color-input]" 
                          id="color-input" 
                  ...
                  <td>
                    <div className="position-relative input_date">
                      <label htmlFor="date-input">
                        <input 
                          type="date" 
                          name="plugin_starter_options[base-input][date-input]" 
                          id="date-input" 
                  ...
                  <td>
                    <div className="position-relative input_datetime_local">
                      <label htmlFor="datetime-local-input">
                        <input 
                          type="datetime-local" 
                          name="plugin_starter_options[base-input][datetime-local-input]" 
                  ...
                  <td>
                    <div className="position-relative textarea">
                      <label htmlFor="textarea-input">
                        <textarea type="text" name="plugin_starter_options[base-input][textarea-input]" id="textarea-input" value={settingData['base-input']['textarea-input']} onChange={(e) => onChange('base-input.textarea-input', e.target.value)}/>
                      </label>
                    </div>
                  </td>
                </tr>
                <tr className="plugin_starter_row">
                  ...
                  <td>
                    <div className="position-relative plugin-starter-switcher">
                      <label htmlFor="plugin_starter_options_switch-input">
                        <input 
                          type="checkbox" 
                          name="plugin_starter_options[base-input][switch-input]" 
                          id="plugin_starter_options_switch-input" 
                          value="1" 
                            ...
                            return (
                              <div className="radio-unit" key={index}>
                                <input 
                                  ...
                                  name="plugin_starter_options[base-input][radio-input]" 
                  ...
                  <td>
                    <div className="position-relative datalist">
                      <label htmlFor="datalist-input">
                        <input 
                          list="plugin_starter_options_datalist-input" 
                          name="plugin_starter_options[base-input][datalist-input]" 
                          id="datalist-input" 
                  ...
                  <td>
                    <div className="position-relative select">
                      <label htmlFor="select-input">
                        <select 
                          name="plugin_starter_options[base-input][select-input]" 
                          id="select-input"
                              ...
                              <div className="checkbox-unit" key={index}>
                                <label>
                                  <input 
                                    type="checkbox" 
                                    value={value} 
                                    name="plugin_starter_options[array-input][checkbox-input][]"
                  ...
                  <td>
                    <div className="position-relative select">
                      <label htmlFor="multi-select-input">
                        <select 
                          name="plugin_starter_options[array-input][multi-select-input][]" 
